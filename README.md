...
such as Ada, Fortran, Kotlin Native, Nim, Objective-C, Pascal, [Swift](https://github.com/Unity-Billal-mesloub/codelldb/wiki/Swift)
and Zig.
...
- Windows 10 and 11 for x86_64. [See Windows notes in wiki!](https://github.com/Unity-Billal-mesloub/codelldb/wiki/Windows)
...
- [Wiki pages](https://github.com/Unity-Billal-mesloub/codelldb/wiki) - [troubleshooting](https://github.com/Unity-Billal-mesloub/codelldb/wiki/Troubleshooting) and other tips and tricks.
- [Discussions](https://github.com/Unity-Billal-mesloub/codelldb/discussions) - for questions and discussions.

# Screenshots

C++ debugging with data visualization ([Howto](https://github.com/Unity-Billal-mesloub/codelldb/wiki/Data-visualization)):<br>
